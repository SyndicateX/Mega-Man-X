...
class Image
{
  ...
  protected:
	...
	bool	fileCoords;
	std::vector<std::vector<int>> spriteCoords_;
  ...
  public:
	...
	// Return state of action.
	virtual ShotType getShotType() { return spriteData.shotType; }
	...
	// Set state of action
	virtual void setShotType(ShotType newShotType)
	{
		spriteData.shotType = newShotType;
	}
	...
	virtual bool Image::initialize(SpriteCoordinates spriteCoords);
