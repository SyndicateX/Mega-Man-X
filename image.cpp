...
bool Image::initialize(SpriteCoordinates spriteCoords)
{
	try{
		spriteCoords_ = spriteCoords.getCoords();
...
inline void Image::setRect() 
{
	if (fileCoords)
	{
		...
		spriteData.rect.right = spriteCoords_[currentFrame][0] + spriteCoords_[currentFrame][2];		//x + width
		spriteData.rect.top = spriteCoords_[currentFrame][1];											//y
		spriteData.rect.bottom = spriteCoords_[currentFrame][1] + spriteCoords_[currentFrame][3];		//y + height
	}
	else
	{
		// configure spriteData.rect to draw currentFrame
